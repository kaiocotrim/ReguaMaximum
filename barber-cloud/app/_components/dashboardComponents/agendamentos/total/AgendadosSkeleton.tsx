...
export default function AgendadosSkeleton() {
  return (
    <div className="relative rounded-3xl p-4 md:p-8 bg-gradient-to-b from-zinc-950 via-black to-zinc-950 overflow-hidden">
      ...
      <div className="relative mb-6 space-y-2">
        <div className="h-5 w-40 rounded-md bg-zinc-800/60 animate-pulse" />
        <div className="h-4 w-56 rounded-md bg-zinc-800/40 animate-pulse" />
      </div>
        ...
        {Array.from({ length: 6 }).map((_, i) => (
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-zinc-800/60 animate-pulse" />
            ...
            <div className="space-y-2">
              ...
              <div className="h-3 w-2/5 rounded bg-zinc-800/40 animate-pulse" />
              <div className="h-3 w-1/3 rounded bg-zinc-800/40 animate-pulse" />
            </div>
            <div className="h-8 w-full rounded-lg bg-zinc-800/30 animate-pulse" />
          </div>
        ))}
      </div>
    </div>
