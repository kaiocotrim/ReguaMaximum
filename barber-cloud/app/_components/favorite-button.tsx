...
//               <AlertDialogCancel className="flex-1 cursor-pointer border border-[#2a2a28] bg-transparent text-[#888780] hover:border-[#444441] hover:bg-transparent hover:text-[#f0efe8]">
//                 Cancelar
//               </AlertDialogCancel>
//               <AlertDialogAction
//                 className="flex-1 cursor-pointer bg-[#C3F32C] font-medium text-[#111110] transition-all hover:bg-[#C3F32C]/88 active:scale-[0.97]"
//                 onClick={() => {
//                   setShowAlert(false)
//                   setOpenLogin(true)
//                 }}
...
const FavoriteButton = ({
  ...
  const handleFavorite = async () => {
    // usuário não logado → abre alerta
    if (!session?.user) {
      setShowAlert(true)
      return
    }
